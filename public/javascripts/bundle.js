...
document.addEventListener('DOMContentLoaded', function() {
  React.render(React.createElement(FormComponent, {categories: ["philosophy","sources","redesigns","inspiration","tutorials",]}), document.body);
}, false);
...
},{"./components/FormComponent":149,"react":148}],2:[function(require,module,exports){
  ...
  render: function () {
    return (
      React.createElement("div", {className: "container"}, 
        React.createElement("h1", null, "Submit a Design Resource"), 
        React.createElement("div", null, React.createElement("p", {id: "banner"})), 
        React.createElement("div", {id: "resourceForm"}, 
          React.createElement("form", {id: "submitResource", onsubmit: "return submitForm()"}, 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("label", {htmlFor: "titleInput"}, "Title"), 
              React.createElement("input", {id: "titleInput", type: "text", name: "title", value: "<%= title %>", required: true})
            ), 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("label", {htmlFor: "urlInput"}, "URL"), 
              React.createElement("input", {id: "urlInput", type: "url", name: "URL", value: "<%= url %>", required: true})
            ), 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("label", {htmlFor: "twitterInput"}, "Twitter"), 
              React.createElement("input", {id: "twitterInput", type: "text", name: "twitter", value: "<%= twitter %>", required: true})
            ), 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("label", {htmlFor: "descriptionInput"}, "Description"), 
              React.createElement("textarea", {id: "descriptionInput", name: "description", required: true})
            ), 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("label", {htmlFor: "categoryInput"}, "Category"), 
              React.createElement("select", {id: "categoryInput", name: "category"}, 
                this.props.categories.map(function(category) {
                  return React.createElement("option", null, category)
                })
              )
            ), 
            React.createElement("div", {className: "form-item"}, 
              React.createElement("input", {type: "submit", value: "Submit Resource", id: "resourceSubmit"})
            )
          )
        )
      )
